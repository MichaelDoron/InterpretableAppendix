...
parser.add_argument(
    ...
    default=False,
    metavar='CSPR',
    help='Whether to add conv sparsity')
parser.add_argument(
    '--lstm-sparsity',
    default=False,
    metavar='LSPR',
    help='Whether to add lstm sparsity')
parser.add_argument(
    '--load-appendix',
    default=False,
    metavar='APP',
    help='Whether to load appendix')
parser.add_argument(
    '--lstm-app',
    default=False,
    metavar='LSTMAPP',
    help='Whether to add LSTM')
parser.add_argument(
    '--conv-app',
    default=False,
    metavar='CONVAPP',
    help='Whether to add CONV')
parser.add_argument(
    '--eval',
    default=False,
    metavar='EVAL',
    ...
    if args.shared_optimizer:
        ...
        if args.optimizer == 'Adam':
            optimizer = SharedAdam(
                filter(lambda p: p.requires_grad, shared_model.parameters()), lr=args.lr, amsgrad=args.amsgrad)
